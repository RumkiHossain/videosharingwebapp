...
class VideoProcessor {
    ...
    private $con;
    private $sizeLimit = 500000000; // 500 MB
    private $allowedTypes = array("mp4", "flv", "webm", "mkv", "vob", "ogv", "ogg", "avi", "wmv", "mov", "mpeg", "mpg");
    private $ffmpegPath;  // relative file path
    private $ffprobePath;

    public function __construct($con) {
        $this->con = $con;
        $this->ffmpegPath = realpath("ffmpeg/bin/ffmpeg.exe"); // make absulate file path 
    ...
    public function upload($videoUploadData) {
        ...
        //file name changer . make url
        

        $tempFilePath = str_replace(" ", "_", $tempFilePath);
        // convert al spaces to under_scores
    ...
    public function convertVideoToMp4($tempFilePath, $finalFilePath){
        $cmd = "$this->ffmpegPath -i $tempFilePath $finalFilePath 2>&1"; //cmd line // error messages // ffmpeg
