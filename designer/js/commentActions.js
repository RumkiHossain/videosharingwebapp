...
function likeComment(commentId, button, videoId) {
    ...
    .done(function(numToChange) {
        ...
        if(numToChange < 0) {
            ...
            likeButton.find("img:first").attr("src", "designer/images/icons/thumb-up.png");
        }
        else {
            likeButton.find("img:first").attr("src", "designer/images/icons/thumb-up-active.png")
        }

        dislikeButton.find("img:first").attr("src", "designer/images/icons/thumb-down.png");
    });
}
...
function dislikeComment(commentId, button, videoId) {
    ...
    .done(function(numToChange) {
        ...
        if(numToChange > 0) {
            ...
            dislikeButton.find("img:first").attr("src", "designer/images/icons/thumb-down-active.png")
        }
